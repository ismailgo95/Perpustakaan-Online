        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./examples/icons.html">
              <i class="ni ni-planet text-blue"></i> Data Kategori
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./examples/maps.html">
              <i class="ni ni-pin-3 text-orange"></i> Data Buku
            </a>
          </li>
          <li class="nav-item">
          ...
          <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 text-center">
              ...
              <div class="btn-wrapper mt-5">
                <a href="login.php" class="btn btn-lg btn-white btn-icon mb-3 mb-sm-0">
                  <span class="btn-inner--icon"><i class="ni ni-key-25"></i></span>
                  <span class="btn-inner--text">LOGIN</span>
                </a>
                <a href="./examples/register.html" class="btn btn-lg btn-github btn-icon mb-3 mb-sm-0" target="_blank">
          ...
          <div class="row align-items-center justify-content-xl-between">
            <div class="col-xl-6">
              <div class="copyright text-center text-xl-left text-muted">
                &copy; 2018 <a href="" class="font-weight-bold ml-1" target="_blank" align="center">Perpustakaan Online</a>
                </div>
            </div>
              <div class="col-xl-6">
