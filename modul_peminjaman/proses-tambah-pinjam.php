...
if ($stok_buku < 1) {
	$_SESSION['messages'] = '<font color="red" align="center">!! Stok buku sudah habis, proses peminjaman gagal !!</font>';
...
if ($hasil == true) {
    ...
    $_SESSION['messages'] = '<font color="green" align="center">!! Peminjaman sukses !!</font>';
